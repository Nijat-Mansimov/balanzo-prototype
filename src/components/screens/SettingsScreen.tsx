...
import { ArrowLeft, KeyRound, Shield, LogOut, Check, ChevronRight, X, ExternalLink } from 'lucide-react';
    ...
    <div className="space-y-4 px-4 pb-24 pt-1 animate-in fade-in duration-300">
        ...
        <div className="divide-y divide-neutral-100 dark:divide-neutral-700/60 rounded-3xl bg-white dark:bg-neutral-800 border border-neutral-200/80 dark:border-neutral-700/70 overflow-hidden shadow-sm">
          ...
          <div className="p-4 space-y-1">
            <div className="flex items-center gap-2 text-xs font-bold text-neutral-900 dark:text-white">
              ...
              <span>Balanzo never moves money</span>
            </div>
            <p className="text-[11px] text-neutral-500 dark:text-neutral-400 leading-relaxed">
              Balanzo is an expense tracking and relationship management system. It does not hold, transfer, or process real funds. All payments occur externally.
            </p>
          </div>
      ...
      <div className="space-y-2">
        ...
        <div className="divide-y divide-neutral-100 dark:divide-neutral-700/60 rounded-3xl bg-white dark:bg-neutral-800 border border-neutral-200/80 dark:border-neutral-700/70 overflow-hidden shadow-sm">
          ...
          <button
            onClick={() => alert('Logged out from all active sessions')}
          ...
          <div className="w-full bg-white dark:bg-neutral-800 rounded-t-3xl p-5 shadow-2xl border-t border-neutral-200 dark:border-neutral-700 max-h-[85%] overflow-y-auto animate-in slide-in-from-bottom-5 duration-200">
            ...
            <div className="mt-4 space-y-3">
              <p className="text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed">
                We'll send a link to <strong className="text-neutral-900 dark:text-white">{CURRENT_USER.email}</strong> to set a new password.
              </p>
